 ...
 *   - `warn`  Warn the userModel of duplicate function definitions etc
 *
 * @param {Node} root
 * @api private
 */
...
Evaluator.prototype.visitFunction = function(fn){
  ...
  if (user) this.warn('userModel-defined function "' + fn.name + '" is already defined');
...
Evaluator.prototype.visitCall = function(call){
  ...
  // Not a function? try userModel-defined or built-ins
  ...
  // User-defined
    ...
    debug('%s is userModel-defined', call);
...
/**
 * Lookup JavaScript userModel-defined or built-in function.
 *
 * @param {String} name
 * @return {Function}
 * @api private
