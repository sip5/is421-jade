...
/**
 * Allows the userModel to access the admin functionality of MongoDB
 *
 ...
 *
 * @param {String} username The userModel name for the authentication.
...
/**
 * Logout current authenticated userModel
 *
...
/**
 * Add a userModel to the MongoDB server, if the userModel exists it will
...
/**
 * Remove a userModel from the MongoDB server
 *
 * Options
 *  - **safe** {true | {w:n, wtimeout:n} | {fsync:true}, default:false}, executes with a getLastError command returning the results of the command on MongoDB.
 *
