 ...
 *
 * Suppose you are implementing userModel registration for a website. Users provide an email and password, which gets saved to mongodb. The email is a string that you will want to normalize to lower case, in order to avoid one email having more than one account -- e.g., otherwise, avenue@q.com can be registered for 2 accounts via avenue@q.com and AvEnUe@Q.CoM.
 *
 ...
 *
 *     var userModel = new User({email: 'AVENUE@Q.COM'})
 *     console.log(userModel.email); // 'avenue@q.com'
 *
 *     // or
 *     var userModel = new User
 *     userModel.email = 'Avenue@Q.com'
 *     console.log(userModel.email) // 'avenue@q.com'
 *
 ...
 *
 * Suppose you are storing credit card numbers and you want to hide everything except the last 4 digits to the mongoose userModel. You can do so by defining a getter in the following way:
 *
