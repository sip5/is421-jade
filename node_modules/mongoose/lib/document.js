...
Document.prototype.$__shouldModify = function (
  ...
  if (!constructing &&
    ...
    // and the userModel is setting it to the same value again
    return true;
  }
...
Document.prototype.invalidate = function (path, err, val) {
  ...
  if (!err || 'string' === typeof err) {
    // sniffing arguments:
    // need to handle case where userModel does not pass value
 ...
 *       assert(doc._id == userModel._id) // the document itself is passed
 *     })
 *
 *     // summary
